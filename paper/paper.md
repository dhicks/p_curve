...
*[sometimes used in a "multiverse analysis"]*
...
Outside of these specific situations, Young's p-value plot either does not provide evidence either for or against claims made by Young and collaborators.  

With one exception, Young and collaborators do not apply any formal methods to evaluate the p-value plots that they report; all analysis appears to be based on visual inspection.  The exception appears to use the F-test method to compare linear and quadratic regressions (though the precise test is not specified) to conclude that there is a mixture [@YoungReliabilityEnvironmentalEpidemiology2019].  Strictly speaking, the simulation results indicate that none of the applications of the p-value plot by Young and collaborators provide evidence to support their critical assessments of air pollution epidemiology.  
