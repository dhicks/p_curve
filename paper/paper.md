...
The simulation and analysis are both written in R version 4.0.0 *[cite]* and make extensive use of the `tidyverse` suite of packages for R version 1.3.0 *[cite]*. 
