...
The simulation, analysis, and outputs (figures and tables included here) are publicly available and automatically reproduced.  Code is available at <https://github.com/dhicks/p_curve> and the automatically reproduced analysis can be viewed at <https://dhicks.github.io/p_curve/>.  
